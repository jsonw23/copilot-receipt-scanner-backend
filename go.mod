module copilot-receipt-scanner/image-handler

go 1.18

require github.com/aws/aws-sdk-go-v2/service/sns v1.17.6
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/textract v1.15.2
